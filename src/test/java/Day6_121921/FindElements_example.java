...
public class FindElements_example {
    public static void main(String[] args) throws InterruptedException {
        ...
        driver.findElements(By.xpath("//*[contains(@class,'_yb_1rhax')]")).get(1).click();
        driver.findElement(By.xpath("//*[contains(@class,'_yb_1rhax')]")).click();
        driver.findElement(By.xpath("//*[@class='_yb_1rhax']")).click();
        driver.findElements(By.xpath("//*[@class='_yb_1rhax']")).get(1).click();
